...
public class MemberDao {
	...
	public int insertMemberInfo(Connection conn, MemberInfo memberInfo) throws SQLException {
		...
		String insert_sql = "insert into member (idx, userid, password, username, userphoto ) values(seq_member.nextval, ?, ?, ?, ?)";
	...
	public List<MemberInfo> selectList(Connection conn) throws SQLException {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		List<MemberInfo> messageList = new ArrayList<MemberInfo>();
		try {
